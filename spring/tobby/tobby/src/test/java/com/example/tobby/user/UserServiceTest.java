...
class UserServiceTest {
  ...
  public void setUp() {
    users = Arrays.asList(
        ...
        new User("erwins", "신승한", "p3", "a@gmail.com", Level.SILVER, 60,
...
//        checkUserAndLevel(updated.get(0), users.get(3).getId(), users.get(3).getLevel());
    ...
    assertThat(users.get(1)
                    .getLevel()).isEqualTo(Level.SILVER);
    verify(mockUserDao).update(users.get(3));
    assertThat(users.get(3)
                    .getLevel()).isEqualTo(Level.GOLD);
...
//        assertThat(requests.get(1)).isEqualTo(users.get(3).getEmail());
    ...
    assertThat(mailMessages.get(0)
                           .getTo()[0]).isEqualTo(users.get(1)
                                                       .getEmail());
    assertThat(mailMessages.get(1)
                           .getTo()[0]).isEqualTo(users.get(3)
                                                       .getEmail());
  }
